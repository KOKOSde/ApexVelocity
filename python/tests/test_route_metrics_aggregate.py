...
class TestEnergyMetrics:
    ...
    def test_energy_per_km_calculation(self):
        ...
        if analysis.total_distance_km > 0 and analysis.total_energy_kwh > 0:
            ...
            assert (
                abs(analysis.energy_kwh_per_km - expected_efficiency) < 0.001
    ...
    def test_total_distance_matches_segments(self):
        ...
        assert (
            abs(analysis.total_distance_km - expected_km) < 0.01
...
class TestActionDistribution:
    ...
    def test_brake_fraction_calculation(self):
        ...
        if total_distance > 0:
            ...
            assert (
                abs(analysis.brake_fraction - expected_fraction) < 0.01
    ...
    def test_action_fractions_sum_to_one(self):
        ...
        total = (
            ...
            + analysis.coast_fraction
            + analysis.accelerate_fraction
        ...
        assert (
            abs(total - 1.0) < 0.05
        ), f"Action fractions sum to {total}, expected ~1.0"
...
class TestDifficultyScore:
    ...
    def test_curvy_increases_difficulty(self):
        ...
        assert (
            analysis_hard.difficulty_score > analysis_easy.difficulty_score
    ...
    def test_steep_grade_increases_difficulty(self):
        ...
        assert (
            analysis_steep.difficulty_score > analysis_flat.difficulty_score
...
class TestSafetyMarginScore:
    ...
    def test_low_friction_use_high_margin(self):
        ...
        assert (
            analysis.safety_margin_score > 0.5
...
class TestSpeedStatistics:
    ...
    def test_avg_speed_matches_input(self):
        ...
        assert (
            abs(analysis.avg_speed_kmh - expected_kmh) < 1.0
    ...
    def test_max_speed_at_least_avg(self):
        ...
        assert (
            analysis.max_speed_kmh >= analysis.avg_speed_kmh
    ...
    def test_p95_between_avg_and_max(self):
        ...
        assert (
            analysis.avg_speed_kmh <= analysis.p95_speed_kmh <= analysis.max_speed_kmh
...
class TestComfortMetrics:
    ...
    def test_easy_path_low_violations(self):
        ...
        assert (
            analysis.comfort_violations_per_km < 1.0
    ...
    def test_uncomfortable_percentage_reasonable(self):
        ...
        assert (
            0 <= analysis.pct_uncomfortable_distance <= 1.0
...
class TestGeometryMetrics:
    ...
    def test_max_grade_tracked(self):
        ...
        assert (
            analysis.max_grade_percent > 6.0
    ...
    def test_elevation_gain_loss_consistent(self):
        ...
        assert (
            analysis.total_elevation_gain_m > 0 or analysis.total_elevation_loss_m > 0
...
class TestSummaryDict:
    ...
    def test_summary_values_are_rounded(self):
        ...
        assert (
            len(str(summary["difficulty_score"])) < 10
...
class TestHUDDict:
    ...
    def test_hud_values_are_strings(self):
        ...
        for key, value in hud.items():
            assert isinstance(
                value, str
            ), f"HUD value for {key} should be string, got {type(value)}"
