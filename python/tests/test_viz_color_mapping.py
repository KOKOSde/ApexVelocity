...
class TestBackwardsCompatibility:
    ...
    def test_mode_parameter_still_works(self):
        ...
        try:
            ...
            if "mode" in str(e):
                pytest.fail(
                    "'mode' parameter should be accepted for backwards compatibility"
                )
